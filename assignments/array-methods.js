...
let fullName = [];
runners.forEach(function(arr,index){
...
runners.map(function(arr){
   upperC = arr.first_name.toUpperCase();
   allCaps.push(upperC);
...
let largeShirts = [];
const filterShirtsize = runners.filter((arr) => {
...
const ticketTotal = runners.forEach(function(arr){
let ticketPriceTotal =+ arr.donation[i];
